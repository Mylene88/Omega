...
// En production : variable REACT_APP_API_URL depuis .env.production
...
```bash
# Vérifier la variable FRONTEND_URL dans backend/.env.production
...
cat frontend/.env.production | grep TILE_MODE
