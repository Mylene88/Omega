...
// backend/app/api/admin/reports/route.js
/**
 * API pour générer et exporter des rapports
 */

import { requireAdminWithLogging } from '../../../../lib/adminMiddleware';
import { generateActivityReport, generateSecurityReport } from '../../../../lib/reportHelper';
...
export default async function handler(req, res) {
  ...
  const authResult = await requireAdminWithLogging(req, 'GENERATE_REPORT', 'reports');
