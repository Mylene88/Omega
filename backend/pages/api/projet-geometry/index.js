...
//backend/app_backup/api/projet-geometry/route.js

import db from '../../../models';
import { calculateSpatialData } from '../../../utils/spatial';
import { validateProjetData, validateGeometryData } from '../../../utils/validate';
import { successResponse, errorResponse, validationErrorResponse } from '../../../utils/response';
import { withTransaction, createCommuneLiaisons } from '../../../utils/database';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const projetId = req.query.projet_id;
